  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur">
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <span className="hidden items-center gap-1.5 rounded-md border border-border bg-surface px-2 py-1 text-[10px] font-medium uppercase tracking-[0.14em] text-muted-foreground sm:inline-flex">
          <span className="h-1.5 w-1.5 rounded-full bg-healthy shadow-[0_0_6px_var(--healthy)]" />
          PROD · India Region
        </span>
